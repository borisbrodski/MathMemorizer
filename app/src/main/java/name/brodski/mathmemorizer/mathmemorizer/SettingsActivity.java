...
import name.brodski.mathmemorizer.mathmemorizer.preferences.BindPreferenceSummaryToValueListener;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            sBindPreferenceSummaryToValueListener.bind(findPreference("notifications_ringtone_correct_answer"));
            sBindPreferenceSummaryToValueListener.bind(findPreference("notifications_ringtone_wrong_answer"));
            sBindPreferenceSummaryToValueListener.bind(findPreference("notifications_ringtone_starting_alarm"));
        }
