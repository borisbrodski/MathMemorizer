...
public class ExtraRingtonePreference extends DialogPreference {
    ...
    public CharSequence getSummary() {
        ...
        if (mValue != null) {
            ...
            if (mValue.length() == 0)
                ringtoneTitle = mContext.getString(R.string.pref_ringtone_silent);
...
//            else
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        if (mShowSilent)
            sounds.put(mContext.getString(R.string.pref_ringtone_silent), Uri.parse(""));
        ...
        builder.setPositiveButton(R.string.pref_ringtone_dialog_ok, this);
        builder.setNegativeButton(R.string.pref_ringtone_dialog_cancel, this);
